...
public class CustomersView extends javax.swing.JPanel implements EditorRecord {
    ...
    public void writeValueEdit(Object value) {
        ...
        //  Dixon Martinez
        //	18/04/2014 21:48:00
        //	Add Support for location Customer
        isActiveEvent = false;
        txtCountry.setText(Formats.STRING.formatValue(customer[21]));
        setC_CountrysList();
        txtRegion.setText(Formats.STRING.formatValue(customer[20]));
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jComboBoxCountry, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(64, 64, 64)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txtCountry, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(txtRegion, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(txtCity, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(142, 175, Short.MAX_VALUE))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jComboBoxCountry, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtCountry, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel24)
                    .addComponent(txtRegion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jComboBoxRegion, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel23)
                    .addComponent(jComboBoxCity, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 203, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jComboBoxCountryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxCountryActionPerformed
        if(isActiveEvent){
            txtCountry.setText((String) jComboBoxCountry.getSelectedItem());
            this.fillCRegionList();
        }
    ...
    private void jComboBoxRegionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxRegionActionPerformed
        if(isActiveEvent){
            txtRegion.setText((String)jComboBoxRegion.getSelectedItem());
            this.fillCCitiesList();
        }
    ...
    private void jComboBoxCityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxCityActionPerformed
    	if(isActiveEvent){
    		txtCity.setText((String) jComboBoxCity.getSelectedItem());
    	}
    ...
    private Map<String,String> countriesMap, regionMap, citiesMap;
    
    private DataLogicCustomers dlCustomers;
    private boolean            isActiveEvent = true;
    
    /**
     * Add Countrys to Combo Boxes
     * @author Dixon Martinez
     * 18/04/2014
     */
    private void fillCCountriesList(){
    	countriesMap = new HashMap<String, String>();
    	List<C_CountryInfo> countryInfoList = dlCustomers.getC_Countrys();
    	Iterator<C_CountryInfo> countryInfoIterator = countryInfoList.iterator();
    	C_CountryInfo m_C_CountryInfo = null;
    	
    	jComboBoxCountry.removeAllItems();
    	
    	while (countryInfoIterator.hasNext()) {
			m_C_CountryInfo = countryInfoIterator.next();
			countriesMap.put(m_C_CountryInfo.getP_Name(),m_C_CountryInfo.getP_C_Country_ID());
			jComboBoxCountry.addItem(m_C_CountryInfo.getP_Name());
			if(m_C_CountryInfo.getP_Name().equalsIgnoreCase(txtCountry.getText()))
				jComboBoxCountry.setSelectedIndex(jComboBoxCountry.getItemCount() -1);
				
		}    	
    }
    
    /**
     * Add Regions to Combo Box
     * @author Dixon Martinez
     * 18/04/2014
     */
    private void fillCRegionList() {
    	regionMap = new HashMap<String, String>();
    	System.out.println(String.valueOf(jComboBoxCountry.getSelectedItem()));
    	Iterator<C_RegionInfo> regionInfoIterator = dlCustomers.getC_Regions(
    			countriesMap.get(
    						String.valueOf(jComboBoxCountry.getSelectedItem())
    						)
    			).iterator();
		C_RegionInfo m_C_RegionInfo = null;
		
		jComboBoxRegion.removeAllItems();
		jComboBoxRegion.addItem("Seleccione Un Estado");
		jComboBoxRegion.setSelectedIndex(0);
		while (regionInfoIterator.hasNext()) {
			m_C_RegionInfo = regionInfoIterator.next();
			regionMap.put(m_C_RegionInfo.getP_Name(), m_C_RegionInfo.getP_C_Region_ID());
			jComboBoxRegion.addItem(m_C_RegionInfo.getP_Name());
			if(m_C_RegionInfo.getP_Name().equalsIgnoreCase(txtRegion.getText()))
				jComboBoxRegion.setSelectedIndex(jComboBoxRegion.getItemCount() -1);
			
		}
	}

    private void fillCCitiesList() {
        citiesMap = new HashMap<String, String>();
        Iterator<C_CityInfo> cityInfoIterator = dlCustomers.getC_City(
        		regionMap.get( 
        				String.valueOf(jComboBoxRegion.getSelectedItem())
        				)
        			).iterator();

        C_CityInfo m_C_CityInfo = null;

        jComboBoxCity.removeAllItems();
        
        while (cityInfoIterator.hasNext()) {
			m_C_CityInfo = cityInfoIterator.next();
			citiesMap.put(m_C_CityInfo.getP_Name(), m_C_CityInfo.getP_C_City_ID());
			jComboBoxCity.addItem(m_C_CityInfo.getP_Name());
			if(m_C_CityInfo.getP_Name().equalsIgnoreCase(txtCity.getText()))
				jComboBoxCity.setSelectedIndex(jComboBoxCity.getItemCount() -1);
        }
    }
     ...
     * 18/04/2014
     */
    private void setC_CountrysList() {
        int index =0;

        for(index = 0; index < jComboBoxCountry.getItemCount(); index++){
        	if(((String) jComboBoxCountry.getItemAt(index)).equalsIgnoreCase(txtCountry.getText())){
        		jComboBoxCountry.setSelectedIndex(index);
        	}
        }
     ...
     * 18/04/2014
     */
    private void setC_CityList() {
        int index =0;

        for(index = 0; index < jComboBoxCity.getItemCount(); index++){
        	if(((String) jComboBoxCity.getItemAt(index)).equalsIgnoreCase(txtCity.getText())){
        		jComboBoxCity.setSelectedIndex(index);
        	}
        }
