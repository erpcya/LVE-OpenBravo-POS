...
import com.openbravo.pos.fiscalprinter.FiscalPrinter;
...
public class DeviceTicket {
    ...
    public DeviceTicket(Component parent, AppProperties props) {
        ...
        //	Dixon Martinez 15/04/2014 32:08:00
        //	Add support Fiscal Printer
        
        String port = sf.nextToken(',');
        //	End Dixon Martinez
        try {
            ...
            //	Dixon Martinez 15/04/2014 32:08:00
            //	Add support Fiscal Printer
            else if(AppLocal.getIntString("Label.Fiscal_Printer").equals(sFiscalType)){
            	m_deviceFiscal =  new FiscalPrinter(port);
            }
            //	End Dixon Martinez
            else{
            	m_deviceFiscal = new DeviceFiscalPrinterNull();
